...
- Per-repo configuration (`.tf-risk-review.yaml`): fail threshold, address
...
- Reusable composite GitHub Action (`balvanthreddy/tf-risk-review@v1`).
...
[Unreleased]: https://github.com/balvanthreddy/tf-risk-review/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/balvanthreddy/tf-risk-review/releases/tag/v0.1.0
